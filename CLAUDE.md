...
This project is indexed by GitNexus as **ai-driven-developement-poc** (269 symbols, 341 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ai-driven-developement-poc/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ai-driven-developement-poc/clusters` | All functional areas |
| `gitnexus://repo/ai-driven-developement-poc/processes` | All execution flows |
| `gitnexus://repo/ai-driven-developement-poc/process/{name}` | Step-by-step execution trace |
